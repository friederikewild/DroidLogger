...
public class EnumExample extends Example
{
    private final Info.Flowers test = Info.Flowers.Sunflower;

    public EnumExample()
    {
        title = "enum:";
        standard = String.valueOf(test);
        example = ToStringFormatter.getString(test);
    }
