...
public class ThrowableExample extends ObjectExample<Throwable>
{
    private final Throwable error;

    public ThrowableExample()
    {
        error = new IllegalArgumentException("Test error");
        initWithTitleFromCreatedObject("Throwable:");
    }

    public Throwable getCreatedObject()
    {
        return error;
    }
}
